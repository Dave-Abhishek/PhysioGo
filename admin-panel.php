...
<script>
  function validateDoctorForm() {
    ...
    if (doctor === "" || dpassword === "" || cdpassword === "" || demail === "" || docFees === "") {
...
<body>
  ...
  <div class="sidebar">
    <div class="logo-details">
      ...
      <span class="logo_name"><a href="#">PhysioGO</a></span>
    </div>
    <ul class="nav-links">
      <li>
  ...
  <div class="section-container" id="sections">
    ...
    <nav>
      <div class="welcome">
        <i class='bx bx-menu sidebarBtn' style="color:#006e89;"></i>
        ...
        <div class="box">
          <div class="right-side">
            ...
            <p>
              ...
              <span style="color: #006e89;">|</span><a href="#list-doc" onclick="clickDiv('#list-doc-list')"> Delete & Edit Doctors</a>
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="home-content" id="list-doc">
      ...
      <table class="doctor-table">
        ...
        <tbody>
          ...
          <td>".$row['password']."</td>
          <td>".$row['docFees']."</td>
          <td><a href='update-doctor.php?un=$row[username]&em=$row[email]&pw=$row[password]&df=$row[docFees]&ct=$row[contact]'><input type='submit' value='update' class='btn  btn-primary'></a>
          <a href='delete-doctor.php? email=$row[email]'><input type='submit' value='DELETE' class='btn btndoc btn-primary'></td>
        </tr>
        ";
          }
          // &pw=$row[password]
      ...
      <div class="form-container" >
        <form class="form-group" method="post" action="admin-panel.php" onsubmit="return validateDoctorForm();">
          ...
          <div class="form-group1">
            ...
            <input type="text" class="form-control" name="dcity" id="dcity">
          </div>
          <div class="form-group1">
            <label for="dstate">State</label>
            <input type="text" class="form-control" name="dstate" id="dstate">
          </div>
          <div class="form-group1">
