...
<body>
    <div class="wrapper">
        <nav class="nav">
            <div class="nav-logo">
                <a href="index.html"><img src="logo.svg" class="logo" alt="">
            </div>
            <div><span class="logoname">PhysioGO</span></div>
            ...
            <!-- <div class="nav-button">
                <button class="btn white-btn" id="registerBtn" onclick="redirectToPatientLogin()"> Register Patient</button> -->
        ...
        <div class="input-box">
            <button class="btnlogin" onclick="window.location.href='loginindex.html'"><a
                    href="loginindex.html">LOGIN</a></button>
            <button class="btnlogin"><a href="registration.html">Register as a Patient</a></button>
            <button class="btnlogin"><a href="doctorregistration.html">Register as a doctor</a></button>
            <!-- <button class="btnlogin" onclick="redirectToAdminLogin()">Admin</button> -->
        </div>
    </div>
