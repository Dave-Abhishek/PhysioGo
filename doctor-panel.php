    ...
    <div class="section-container" id="sections">
        ...
        <nav class="doc-nav">
            <div class="welcome">
                ...
                <span class="admin">Welcome, <?php echo $_SESSION['dname'] ?></span>
            </div>
            <div>
                <form class="form-group" name="searchForm" onsubmit="return validateForm()" method="post"
                    action="search.php">
                    <div class="psearch">
                        ...
                        <div class="submit-btn">
                            <input type="submit" class="btn btn-primary" id="inputbtn" name="search_submit"
                                value="Search">
                        </div>
                    </div>
                </form>
            ...
            <table class="app-table">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        $showCancelAcceptButtons = !$cancelled && !$accepted;
